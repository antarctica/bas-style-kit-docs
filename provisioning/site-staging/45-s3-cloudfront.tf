#
# Defines a single CloudFront distribution with a single origin (S3 static website bucket) for the staging environment
# of the BAS Style Kit Docs project example
#
